...
const PROVINCE_CODE = new Map([
  ["بغداد", 1], ["نينوى", 2], ["البصرة", 3], ["الأنبار", 4], ["ذي قار", 5],
  ["السليمانية", 6], ["القادسية", 7], // (الديوانية)
  ["صلاح الدين", 8], ["النجف", 9], ["كركوك", 10], ["ديالى", 11], ["المثنى", 12],
  ["ميسان", 13], ["واسط", 14], ["أربيل", 15], ["بابل", 16], ["دهوك", 17]
]);
